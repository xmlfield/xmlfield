...
public class XmlFieldDomNodeModifierTest {
    ...
    public void testCreateElement() throws Exception {
        ...
        assertThat((XmlFieldNode<Node>) modifier.createElement(null, node, null), sameInstance(node));
        assertThat((XmlFieldNode<Node>) modifier.createElement(null, node, ""), sameInstance(node));

        // test create element without namespaces
        XmlFieldNode<Node> newNode = (XmlFieldNode<Node>) modifier.createElement(null, node, "Cd");
        ...
        NamespaceMap namespaces = new NamespaceMap("xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"");
        assertThat((XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, null), sameInstance(nodeNs));
        assertThat((XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, ""), sameInstance(nodeNs));
        newNode = (XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, "xsi:Cd");
        assertThat(parser.nodeToXml(newNode), is("<Cd xmlns=\"http://www.w3.org/2001/XMLSchema-instance\"/>"));
        assertThat(
    ...
    public void testCreateElementWithTextContent() throws Exception {
        ...
        // test create element with an empty or null element name
        assertThat((XmlFieldNode<Node>) modifier.createElement(null, node, null, "Some text"), sameInstance(node));
        assertThat((XmlFieldNode<Node>) modifier.createElement(null, node, "", "Some text"), sameInstance(node));

        // test create element without namespaces
        XmlFieldNode<Node> newNode = (XmlFieldNode<Node>) modifier.createElement(null, node, "Cd", "Some text");
        ...
        newNode = (XmlFieldNode<Node>) modifier.createElement(null, node, "Cd", null);
        assertThat(parser.nodeToXml(newNode), is("<Cd/>"));
        assertThat(
                parser.nodeToXml(node),
        ...
        // test create element with namespaces
        NamespaceMap namespaces = new NamespaceMap("xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"");
        assertThat((XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, null, "Some text"),
                sameInstance(nodeNs));
        assertThat((XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, "", "Some text"),
                sameInstance(nodeNs));
        newNode = (XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, "xsi:Cd", "Some text");
    ...
    public void testInsertBefore() throws Exception {
        ...
        XmlFieldNode<Node> newChild = (XmlFieldNode<Node>) modifier.createElement(null, node, "Cd", "Some text");
        ...
        XmlFieldNode<Node> refChild = (XmlFieldNode<Node>) selector.selectXPathToNode(null, "/Catalog/Cd[2]", node);
        ...
        // NamespaceMap namespaces = new NamespaceMap("xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"");
        // refChild = (XmlFieldNode<Node>) selector.selectXPathToNode(namespaces, "/Catalog/xsi:Cd[2]", nodeNs);
        // newChild = (XmlFieldNode<Node>) modifier.createElement(namespaces, nodeNs, "xsi:Cd", "Some text");
    ...
    public void testRemoveAttribute() throws Exception {
        ...
        XmlFieldNode<Node> removedNode = (XmlFieldNode<Node>) modifier.removeAttribute(node, "lastname");
        assertThat(removedNode, nullValue());

        // test to remove an attibute
        removedNode = (XmlFieldNode<Node>) modifier.removeAttribute(node, "name");
    ...
    public void testRemoveChild() throws Exception {
        ...
        XmlFieldNode<Node> oldChild = (XmlFieldNode<Node>) selector.selectXPathToNode(null, "/Catalog/Cd[2]", node);
        try {
        ...
        XmlFieldNode<Node> removedNode = (XmlFieldNode<Node>) modifier.removeChild(node, oldChild);
        ...
        node = parser.xmlToNode(xml);
        oldChild = (XmlFieldNode<Node>) modifier.createElement(null, node, "Cd", "Some text");
