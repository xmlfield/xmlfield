...
public class XmlFieldDomSelectorTest {
	...
	public XmlFieldDomSelectorTest() throws TransformerConfigurationException,
	...
	public void testSelectXPathToBoolean() throws Exception {
		...
		try {
			...
			assertThat(e.getClass().getName(),
					is(XmlFieldXPathException.class.getName()));
		}
	...
	public void testSelectXPathToNode() throws Exception {
		...
		assertThat(
				parser.nodeToXml(selector.selectXPathToNode(null, xpath, node)),
				is(result));
	...
	public void testSelectXPathToNodeList() throws Exception {
		String xpath = "/Catalog/Cd/Title[text()='Greatest Hitss']";
		assertThat(selector.selectXPathToNodeList(null, xpath, node)
				.getLength(), is(0));

		xpath = "/Catalog/Cd";
		String result = "<Cd> <Title>Empire Burlesque</Title> <Artist>Bob Dylan</Artist>  <Country>USA</Country>  <Company>Columbia</Company> <Price>10.90</Price>    <Year>1985</Year></Cd>";
		XmlFieldNodeList results = selector.selectXPathToNodeList(null, xpath,
				node);
	...
	public void testSelectXPathToNumber() throws Exception {
		String xpath = "/Catalog/Cd/Title[text()='Greatest Hitss']";
		assertThat(selector.selectXPathToNumber(null, xpath, node),
				is(Double.NaN));
	...
	public void testSelectXPathToString() throws Exception {
		...
		assertThat(selector.selectXPathToString(null, xpath, node),
				is("Hide your heart"));
