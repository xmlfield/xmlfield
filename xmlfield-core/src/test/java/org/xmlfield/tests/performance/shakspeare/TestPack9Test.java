...
public class TestPack9Test {
	...
	public File createFileFromClasspathResource(String resourceUrl)
			throws IOException {
		File fichierTest = File.createTempFile("xmlFieldTestFile", "");
		FileOutputStream fos = new FileOutputStream(fichierTest);
		InputStream is = XmlFieldDomSelectorTest.class
	...
	public void setUp() throws Exception {
		...
		hugeRomeoAndFatPrincess = FileUtils.readFileToString(fichierTest,
				"UTF-8");
