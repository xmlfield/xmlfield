...
public interface XmlFieldSelector {
     ...
     */
    Boolean selectXPathToBoolean(NamespaceMap namespaces, String xpath, XmlFieldNode<?> node)
            throws XmlFieldXPathException;
     ...
     *             exception thrown when the xpath evaluation failed
     */
    XmlFieldNode<?> selectXPathToNode(NamespaceMap namespaces, String xpath, XmlFieldNode<?> node)
            throws XmlFieldXPathException;
     ...
     *             exception thrown when the xpath evaluation failed
     */
    XmlFieldNodeList selectXPathToNodeList(NamespaceMap namespaces, String xpath, XmlFieldNode<?> node)
            throws XmlFieldXPathException;
     ...
     *             exception thrown when the xpath evaluation failed
     */
    Double selectXPathToNumber(NamespaceMap namespaces, String xpath, XmlFieldNode<?> node)
            throws XmlFieldXPathException;
     ...
     *             exception thrown when the xpath evaluation failed
     */
    String selectXPathToString(NamespaceMap namespaces, String xpath, XmlFieldNode<?> node)
            throws XmlFieldXPathException;
}
