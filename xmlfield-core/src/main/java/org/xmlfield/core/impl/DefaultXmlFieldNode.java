 ...
 * 
 */
public class DefaultXmlFieldNode implements XmlFieldNode<Node> {

    private Node node;

    public DefaultXmlFieldNode(Node node) {
        super();
        this.node = node;
    }
    ...
    public XmlFieldNode<Node> getParentNode() {
        ...
        return new DefaultXmlFieldNode(this.node.getParentNode());
    }
